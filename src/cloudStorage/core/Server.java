...
public class Server{
	...
	public static void init() throws NetworkError, RegisterEnc.PKIError, RegisterSig.PKIError, ClassNotFoundException, SQLException {
		...
		Signer server_sign = new Signer();
		RegisterSig.registerVerifier(server_sign.getVerifier(), Params.SERVER_ID, Params.PKI_DSIG_DOMAIN);
		init(server_decr, server_sign);
	}

	public static void init(Decryptor decr, Signer sign) throws ClassNotFoundException, SQLException {
		server_decr=decr;
		server_sign=sign;
	 ...
	 * @throws SQLException 
	 */
	public static byte[] processRequest(byte[] request) throws MalformedMessage, NetworkError, RegisterEnc.PKIError, RegisterSig.PKIError, SQLException {
		/*
	 ...
	 * @throws SQLException 
	 */
	private static byte[] store(int userID, byte[] signClient, byte[] label_counter_encMsg) throws MalformedMessage, SQLException{
	 ...
	 * @throws SQLException 
	 */
	private static byte[] retrieve(int userID, byte[] label_counter) throws MalformedMessage, SQLException{
	 ...
	 * @throws SQLException 
	 */
	private static byte[] getLastCounter(int userID, byte[] label_nonce) throws MalformedMessage, SQLException{
